...
@SourceType(value = "CDSARP", label = "CDS",uiConfig = "cds-layout.json")
public class CDSConf extends AbstractArpConf<CDSConf> {
  private static final String ARP_FILENAME = "arp/implementation/cds-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.cds.CDSDriver";
